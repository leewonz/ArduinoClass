...
void loop() {
  ...
  cdsValue_Mapped = map(cdsValue, 0, 1023, 0, 255);
  //cdsValue_Mapped = map_exp(cdsValue_Mapped, 0, 255, 2);
 
  analogWrite(led, cdsValue_Mapped);
  
}

float map_exp(float val, float valMin, float valMax, float exponent)
{
